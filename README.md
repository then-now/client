...
##### <img src="https://img.shields.io/badge/django-043300?style=for-the-badge&logo=django&logoColor=white"> <img src="https://img.shields.io/badge/Python-007396?style=for-the-badge&logo=python&logoColor=white"> <img src="https://img.shields.io/badge/PostgreSQL-007396?style=for-the-badge&logo=PostgreSQL&logoColor=white">
...
|                            네비게이션                            |페이지 이동                       |
| :---------------------------------------------------------: |:---------------------------------------------------------: |
| <img src="./images/1.gif" alt="norecommend" width="600px" /> |<img src="./images/2.gif" alt="recommend" width="600px" /> |

### 2. 메인 페이지

|                          장르 변경                         |
| :-----------------------------------------------------------: |
| <img src="./images/3.gif" alt="update" width="1200px" /> |

|                          영화 OST 선택                         |
| :-----------------------------------------------------------: |
| <img src="./images/4.gif" alt="update" width="1200px" /> |

|                          영화 OST 재생 / 멈춤                         |
| :-----------------------------------------------------------: |
| <img src="./images/5.gif" alt="update" width="1200px" /> |

|                          영화 OST 변경                       |
| :-----------------------------------------------------------: |
| <img src="./images/6.gif" alt="update" width="1200px" /> |
...
|                            Vuex                            |Vue                        |
| :---------------------------------------------------------: |:---------------------------------------------------------: |
| <img src="./images/vuex.png" alt="update" width="800px" /> |<img src="./images/vue.png" alt="update" width="400px" />  |
...
리엑트에서 상태관리와 컴포넌트 라이프 사이클에 대해 이해가 조금 부족하다고 생각했는데, Vue를 사용하면서 조금은 다르지만 Flux 패턴에 대해 직관적으로 이해를 하게 된 계기가 되었습니다. 
